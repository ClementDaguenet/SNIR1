...
function geolocalisationv2() // place wash : 0.202684, 47.995579
{
  var adresse = $("#adresse").adresse($("#adresse").adresse());
  console.log(encodeURI(adresse));
  $.getJSON("https://api-adresse.data.gouv.fr/search/?q=" + adresse + "&limit=1")
          .done(function (resultat, status, xhr) {
            console.log(resultat.features[0].properties.city);
...
$(document).ready(function () {
  ...
  // au click sur l'élément ayant pour id "marqueur", faire appel à la fonction geolocalisationv2
  $("#marqueur").click(geolocalisationv2);
});
